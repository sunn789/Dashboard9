...
namespace Modicom.Models.Migrations
{
    ...
    [Migration("20250407210649_EditContactUsMOdel")]
    partial class EditContactUsMOdel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modicom.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Modicom.Models.Entities.SiteContent", b =>
                {
                    ...
                    b.Property<int?>("SiteContentCategoryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SiteContentCategoryId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Modicom.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Modicom.Models.Entities.SiteContent", b =>
                {
                    b.HasOne("Modicom.Models.Entities.SiteContentCategory", "SiteContentCategory")
                        ...
                        .HasForeignKey("SiteContentCategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
